...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b->setNamespace('sf2orm_default_5f559883ab8e37e6300bbbe9074116bc');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_5f559883ab8e37e6300bbbe9074116bc');

        $d = new \Doctrine\Common\Cache\ArrayCache();
        $d->setNamespace('sf2orm_default_5f559883ab8e37e6300bbbe9074116bc');
        ...
        $g->setEntityNamespaces(array('EcommerceBundle' => 'Ecommerce\\EcommerceBundle\\Entity', 'UtilisateursBundle' => 'Utilisateurs\\UtilisateursBundle\\Entity'));
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Ecommerce\EcommerceBundle\Twig\Extensions\TvaExtension A Ecommerce\EcommerceBundle\Twig\Extensions\TvaExtension instance.
     */
    protected function getTvaService()
    {
        return $this->services['tva'] = new \Ecommerce\EcommerceBundle\Twig\Extensions\TvaExtension();
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addGlobal('telephone', '02 00 00 00 00');
        $instance->addGlobal('fax', '02 00 00 00 00');
        $instance->addGlobal('adresse', 'aaaaa - aaaaaa');
