    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/hello')) {
            ...
            if (preg_match('#^/hello/(?P<name>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'pages_homepage')), array (  '_controller' => 'Pages\\PagesBundle\\Controller\\DefaultController::indexAction',));
            }
        ...
        // test
        if ($pathinfo === '/test') {
            return array (  '_controller' => 'EcommerceBundle:Test:test',  '_route' => 'test',);
        }
